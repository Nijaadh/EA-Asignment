...
<body>
    ...
    <div>
        ...
        <div class="form-container">
             <form id="searchForm" action="DispatchItemSearch" method="get">
                <div class="mb-3">
            ...
            <c:if test="${not empty item}">
                ...
                <form action="DispatchController" method="post" onsubmit="return validateQuantity()">
                    <input type="hidden" id="availableQuantity" value="${item.quantity}">
                    <input type="hidden" name="id" value="${item.id}">
                    <div class="form-group">
                        <label for="quantityToDispatch">Quantity to Dispatch</label>
                        <input type="number" class="form-control" id="quantityToDispatch" name="quantityToDispatch" required>
                    </div>
                    <button type="submit" class="btn btn-primary">Dispatch</button>
                    <button type="button" class="btn btn-danger" onclick="redirectToDispatch()">Clear</button>
